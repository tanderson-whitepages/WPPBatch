...
for row in csvReader:
	...
	#	headers.append('Location Valid From')
		headers.append('Location is Valid')
		headers.append('Street1')
		headers.append('Street2')
		headers.append('City')
	...
	#	headers.append('Location Receiving Mail')
		...
		headers.append('Input Completeness')
	#	headers.append('Landline Phone')
		...
		street2 = data.get('street_line_2','')
		city = data.get('city','')
		...
		inputCompleteness = data.get('input_completeness','')
	...
	#	totalValue = '$' + str(data.get('total_value',''))
		...
		#	resultRow.append(rcvMail)
			...
			resultRow.append(warnings)
			resultRow.append(inputCompleteness)
