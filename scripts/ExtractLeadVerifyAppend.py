...
for row in csvReader:
	...
	if rowNum == 1:
		...
		resultRow.append(wppbatchlib.nvl(wppbatchlib.nvl(data.get('phone_checks',{}),{}).get('subscriber_address',{}),{}).get('state',''))
		resultRow.append(wppbatchlib.nvl(wppbatchlib.nvl(data.get('phone_checks',{}),{}).get('subscriber_address',{}),{}).get('postal_code',''))
		resultRow.append(wppbatchlib.nvl(wppbatchlib.nvl(data.get('phone_checks',{}),{}).get('subscriber_address',{}),{}).get('country',''))
